...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item ${B}\subseteq \R^3$ is the plane with normal vector $\vec n=\mat{1\\1\\-1}$ passing through
				the point $\mat{2\\2\\4}$.
			\item ${C}\subseteq \R^3$ is the $x$-axis.
			\item ${D}\subseteq \R^3$ is the plane given in vector form as $\vec x=t\mat{1\\1\\1}+s\mat{-2\\3\\-1}+\mat{0\\1\\5}$.
