...
\begin{document}
	...
	\begin{enumerate}
		...
		\item Is there a linear transformation $\mathcal{T}$ such that $\mathcal{T}\left( \langle 1,-1 \rangle \right) = \langle 1,1 \rangle$ and $\mathcal{T}\left( \langle -1,1 \rangle \right) = \langle -1, -1 \rangle$?  Either give a matrix for such a transformation, or explain why there isn't one.
		
		\item Is there a linear transformation $\mathcal{R}$ such that $\mathcal{R}\left( \langle 1,1 \rangle \right) = \langle 1,-1 \rangle$, and $\mathcal{R}\left( \langle -1,-1 \rangle \right) = \langle -1,1 \rangle$?  Either give a matrix for such a transformation, or explain why there isn't one.
